...
namespace Moirai.Atropos.Editor
{
    public class BuildPipelineWindow : EditorWindow
    {
        ...
        private void DrawHeader()
        {
            ...
            EditorGUILayout.LabelField("打包工具", titleStyle, GUILayout.Height(30));
            GUILayout.FlexibleSpace();
        ...
        private void LoadSettings()
        {
            ...
            _platformIndex = EditorPrefs.GetInt("BP_BuildTarget", -1);
            ...
            _config.MinimalPackage = EditorPrefs.GetBool("BP_MinimalPackage", false);
            _config.RetainTags = EditorPrefs.GetString("BP_RetainTags", "");

            _config.EnableSharePackRule = EditorPrefs.GetBool("BP_EnableSharePack", true);
            ...
            _config.BuildPlayer = EditorPrefs.GetBool("BP_BuildPlayer", false);

            _playerPlatformIndex = EditorPrefs.GetInt("BP_PlayerPlatform", -1);
            ...
            _config.PlayerOutputPath = EditorPrefs.GetString("BP_PlayerOutput",
        ...
        private void SaveSettings()
        {
            ...
            EditorPrefs.SetString("BP_RetainTags", _config.RetainTags);
            EditorPrefs.SetBool("BP_EnableSharePack", _config.EnableSharePackRule);
            ...
            EditorPrefs.SetInt("BP_PlayerPlatform", _playerPlatformIndex);
            EditorPrefs.SetString("BP_PlayerOutput", _config.PlayerOutputPath);
        }
