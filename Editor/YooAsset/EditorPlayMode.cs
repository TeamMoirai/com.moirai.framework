...
namespace YooAsset.Editor
{
    public static class EditorPlayMode
    {
        ...
        {
            EditorPrefs.SetInt(YooAssetHandler.EDITOR_PLAY_MODE_KEY, (int)EPlayMode.EditorSimulateMode);
        }

        [MenuItem("YooAsset/Editor PlayMode/EditorMode (编辑器下的模拟模式)", true)]
        public static bool EditorModeValidation()
        {
            return EditorPrefs.GetInt(YooAssetHandler.EDITOR_PLAY_MODE_KEY) != (int)EPlayMode.EditorSimulateMode;
        }
        ...
        {
            EditorPrefs.SetInt(YooAssetHandler.EDITOR_PLAY_MODE_KEY, (int)EPlayMode.OfflinePlayMode);
        }

        [MenuItem("YooAsset/Editor PlayMode/OfflinePlayMode (单机模式)", true)]
        public static bool OfflinePlayModeValidation()
        {
            return EditorPrefs.GetInt(YooAssetHandler.EDITOR_PLAY_MODE_KEY) != (int)EPlayMode.OfflinePlayMode;
        }
        ...
        {
            EditorPrefs.SetInt(YooAssetHandler.EDITOR_PLAY_MODE_KEY, (int)EPlayMode.HostPlayMode);
        }

        [MenuItem("YooAsset/Editor PlayMode/HostPlayMode (联机运行模式)", true)]
        public static bool HostPlayModeValidation()
        {
            return EditorPrefs.GetInt(YooAssetHandler.EDITOR_PLAY_MODE_KEY) != (int)EPlayMode.HostPlayMode;
        }
        ...
        {
            EditorPrefs.SetInt(YooAssetHandler.EDITOR_PLAY_MODE_KEY, (int)EPlayMode.WebPlayMode);
        }

        [MenuItem("YooAsset/Editor PlayMode/WebGLPlayMode (WebGL运行模式)", true)]
        public static bool WebPlayModeValidation()
        {
            return EditorPrefs.GetInt(YooAssetHandler.EDITOR_PLAY_MODE_KEY) != (int)EPlayMode.WebPlayMode;
        }
