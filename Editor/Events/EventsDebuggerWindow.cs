...
namespace Moirai.Atropos.Events.Editor
{
    ...
    internal class EventsDebuggerImpl : CoordinatorDebugger
    {
        ...
        [SerializeField] private List<EventTypeFilterStateStruct> m_StateList;
        ...
        private readonly List<IRegisteredCallbackLine> m_RegisteredEventCallbacksDataSource = new List<IRegisteredCallbackLine>();
        ...
        private readonly Dictionary<ulong, long> m_EventTimestampDictionary = new Dictionary<ulong, long>();
