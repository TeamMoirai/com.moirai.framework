...
namespace Service.Save
{
    ...
    public class SaveKeyProviderTests
    {
        ...
        public void Static_Configure_InvalidatesCache()
        {
            ...
            provider.SetDerivationParameters("new-project-secret", SaveEncryptor.DEFAULT_SALT, SaveEncryptor.DEFAULT_ITERATIONS);
        ...
        public void Passphrase_HandlerRoundTrip()
        {
            ...
            var reader = new AESEncryptedSaveHandler { KeyProvider = readerProvider };
        ...
        public void Hkdf_HandlerIsolation_PerUser()
        {
            ...
            {
                KeyProvider = new HKDFPerUserSaveKeyProvider { UserId = "user-b" }
            };
