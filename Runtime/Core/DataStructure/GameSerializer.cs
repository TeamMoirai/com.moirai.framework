...
namespace Moirai.Atropos
{
    ...
    public abstract class GameSerializer<T>
    {
        ...
        public void RegisterSerializeCallback(byte version, SerializeCallback callback)
        {
            if (callback == null)
            {
                throw new GameException("Serialize callback is invalid.");
            }
        ...
        public void RegisterDeserializeCallback(byte version, DeserializeCallback callback)
        {
            if (callback == null)
            {
                throw new GameException("Deserialize callback is invalid.");
            }
        ...
        public void RegisterTryGetValueCallback(byte version, TryGetValueCallback callback)
        {
            if (callback == null)
            {
                throw new GameException("Try get value callback is invalid.");
            }
        ...
        public bool Serialize(Stream stream, T data)
        {
            ...
            {
                throw new GameException("No serialize callback registered.");
            }
