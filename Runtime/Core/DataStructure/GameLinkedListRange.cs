...
namespace Moirai.Atropos
{
    ...
    public readonly struct GameLinkedListRange<T> : IEnumerable<T>, IEnumerable
    {
        ...
        {
            private readonly GameLinkedListRange<T> _gameLinkedListRange;
            ...
            internal Enumerator(GameLinkedListRange<T> range)
            {
                ...
                _gameLinkedListRange = range;
                _current = _gameLinkedListRange._first;
            ...
            {
                if (_current == null || _current == _gameLinkedListRange._terminal)
                {
                    return false;
                }
