...
namespace Moirai.Atropos
{
    ...
    /// <remarks>适用于高频增删操作、GC敏感环境：如游戏对象池、技能释放队列等需要频繁增删节点的场景</remarks>
    public sealed class GameLinkedList<T> : ICollection<T>, IEnumerable<T>, ICollection, IEnumerable
    {
        ...
        /// </summary>
        /// <param name="array">一维数组，它是从链表复制的元素的目标。数组必须有从零开始的索引。</param>
        ...
        /// <summary>
        /// 从指定的 ICollection 索引开始，将数组的元素复制到一个数组中。
        /// </summary>
        /// <param name="array">一维数组，它是从 ICollection 复制的元素的目标。数组必须有从零开始的索引。</param>
        /// <param name="index">array 中从零开始的索引，从此处开始复制。</param>
