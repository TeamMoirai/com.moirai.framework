...
namespace Moirai.Atropos
{
    ...
    {
        [ThreadStatic] private static StringBuilder s_CacheStringBuilder;
        ...
        {
            StringBuilder stringBuilder = s_CacheStringBuilder;
        ...
        {
            if (stringBuilder.Capacity <= MAX_BUILDER_SIZE)
            {
