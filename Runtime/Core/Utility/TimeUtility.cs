...
namespace Moirai.Atropos
{
    ...
    public static class TimeUtility
    {
        ...
        static readonly long epochTicks = new DateTime(1970, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc).Ticks;
        static readonly long secDivisor = (long)Math.Pow(10, 7);
        static readonly long msecDivisor = (long)Math.Pow(10, 4);
