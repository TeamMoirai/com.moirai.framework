...
namespace Moirai.Atropos
{
    public static partial class ObjectUtility
    {
        ...
        public interface IObjectHelper
        {
            ...
            /// <returns></returns>
            public T InstantiateObject<T>(T original, bool playerOwned = false, bool allowNetworked = true)
            ...
            /// <typeparam name="T"></typeparam>
            /// <returns></returns>
            public T InstantiateObject<T>(T original, Transform parent, bool playerOwned = false,
            ...
            /// <typeparam name="T"></typeparam>
            /// <returns></returns>
            public T InstantiateObject<T>(T original, Vector3 position, Quaternion rotation, bool playerOwned = false,
                bool allowNetworked = true) where T : UnityEngine.Object;
            ...
            /// <typeparam name="T"></typeparam>
            /// <returns></returns>
            public T InstantiateObject<T>(T original, Vector3 position, Quaternion rotation, Transform parent,
