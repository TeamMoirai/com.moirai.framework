        ...
        private static void ApplyValue(ref TweenState state, float normalizedTime)
        {
            ...
            switch (state.OperationType)
            {
                ...
                case TweenOperationType.RotationQuat:
                {
                    if (state.Target is Transform trans && trans != null)
                    {
                        Quaternion from = new Quaternion(state.StartX, state.StartY, state.StartZ, state.StartExtra);
                ...
                case TweenOperationType.SpriteColor:
                {
                    ...
                    {
                        sr.color = Color.LerpUnclamped(state.StartColor, state.EndColor, t);
                    }
                    break;
                }
                ...
                case TweenOperationType.MaterialColor:
                {
                    ...
                    {
                        mat.color = Color.LerpUnclamped(state.StartColor, state.EndColor, t);
                    }
                    break;
                }
                ...
                case TweenOperationType.UIColor:
                {
                    ...
                    {
                        g.color = Color.LerpUnclamped(state.StartColor, state.EndColor, t);
                    }
                    break;
                }
