...
namespace Moirai.Atropos
{
    public static partial class ColorsUtility
    {
        ...
        // 注意：以下颜色名称来自 CSS3 规范，第 4.3 节 扩展颜色关键字
        ...
        public static readonly Color YellowAmber = new Color32(255, 196, 0, 255);
        ...
        private static Dictionary<EColor, Color> s_ColorDictionary;
        ...
        {
	        s_ColorDictionary ??= new Dictionary<EColor, Color>
	        {
		        ...
		        { EColor.YellowAmber, YellowAmber },
		        { EColor.BestRed, BestRed }
	        };

	        if (s_ColorDictionary.TryGetValue(color, out var value))
            {
                return value;
            }
            else
