...
namespace Moirai.Atropos.Audio
{
    ...
    public class AudioFadeEvent : EventBase<AudioFadeEvent>, IAudioModuleEvent
    {
        ...
        public static void Trigger(EAudioFadeEventMode mode, int soundID, float duration, float finalVolume, TweenEase ease)
        {
            using var evt = GetPooled(mode, soundID, duration, finalVolume, ease);
