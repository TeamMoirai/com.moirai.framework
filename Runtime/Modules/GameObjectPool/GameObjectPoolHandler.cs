...
namespace Moirai.Atropos.GameObjectPool
{
    ...
    /// <para>由 <see cref="GameObjectPoolSettings"/> 序列化配置，可替换为自定义对象池后端。</para>
    /// </summary>
    [Serializable]
    public class GameObjectPoolHandler : FrameworkHandler
    {
        #region 常量 [CONSTANTS]
        ...
        [NonSerialized] private RuntimeGameObjectPool[] _pools = new RuntimeGameObjectPool[8];
