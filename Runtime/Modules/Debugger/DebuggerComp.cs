...
namespace Moirai.Atropos.Debugger
{
    ...
    public sealed partial class DebuggerComp : MonoBehaviour
    {
        private static DebuggerComp s_Instance;

        public static DebuggerComp Instance => s_Instance;
        ...
        private RuntimeMemoryInformationWindow<UnityEngine.Object> _runtimeMemoryAllInformationWindow = new RuntimeMemoryInformationWindow<UnityEngine.Object>();
        ...
        private ServiceSystemInformationWindow _serviceSystemInformationWindow = new ServiceSystemInformationWindow();
        ...
        {
            s_Instance = this;
            s_Instance.gameObject.name = $"[{nameof(DebuggerComp)}]";
        ...
        {
            _debuggerService = ServiceSystem.GetService<IDebuggerService>();
            ...
            var  lastIconY = SettingUtility.GetFloat(Constant.Debug.ICON_Y, DefaultIconRect.y);
            var lastWindowX = SettingUtility.GetFloat(Constant.Debug.WINDOW_X, DefaultWindowRect.x);
            var lastWindowY = SettingUtility.GetFloat(Constant.Debug.WINDOW_Y, DefaultWindowRect.y);
            var lastWindowWidth = SettingUtility.GetFloat(Constant.Debug.WINDOW_WIDTH, DefaultWindowRect.width);
            var lastWindowHeight = SettingUtility.GetFloat(Constant.Debug.WINDOW_HEIGHT, DefaultWindowRect.height);
            _windowScale = SettingUtility.GetFloat(Constant.Debug.WINDOW_SCALE, DefaultWindowScale);
        ...
        private void Start()
        {
            ...
            switch (m_ActiveWindow)
            {
                ...
                case DebuggerActiveWindowType.OnlyOpenWhenDevelopment:
                    ActiveWindow = UnityEngine.Debug.isDebugBuild || CommandLineUtility.GetShowDebugger();
                    break;

                case DebuggerActiveWindowType.OnlyOpenInEditor:
                    ActiveWindow = Application.isEditor || CommandLineUtility.GetShowDebugger();
                    break;

                default:
                    ActiveWindow = CommandLineUtility.GetShowDebugger();
                    break;
            }
        }
        ...
        private void Update()
        {
            _fpsCounter.Update(GameTime.deltaTime, GameTime.unscaledDeltaTime);
        }
