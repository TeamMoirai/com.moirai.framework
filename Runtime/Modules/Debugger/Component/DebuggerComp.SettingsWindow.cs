...
namespace Moirai.Atropos.Debugger
{
    public sealed partial class DebuggerComp
    {
        ...
        {
            private DebuggerComp _debugger = null;
            ...
            public override void Initialize(params object[] args)
            {
                ...
                _lastIconX = SettingUtility.GetFloat(Constant.Debug.ICON_X, DefaultIconRect.x);
                _lastIconY = SettingUtility.GetFloat(Constant.Debug.ICON_Y, DefaultIconRect.y);
                _lastWindowX = SettingUtility.GetFloat(Constant.Debug.WINDOW_X, DefaultWindowRect.x);
                _lastWindowY = SettingUtility.GetFloat(Constant.Debug.WINDOW_Y, DefaultWindowRect.y);
                _lastWindowWidth = SettingUtility.GetFloat(Constant.Debug.WINDOW_WIDTH, DefaultWindowRect.width);
                _lastWindowHeight = SettingUtility.GetFloat(Constant.Debug.WINDOW_HEIGHT, DefaultWindowRect.height);
                _debugger.WindowScale = _lastWindowScale = SettingUtility.GetFloat(Constant.Debug.WINDOW_SCALE, DefaultWindowScale);
            ...
            protected override void OnDrawScrollableWindow()
            {
                ...
                GUILayout.BeginVertical("box");
                {
                    ...
                    GUILayout.BeginHorizontal();
                    {
                        ...
                        {
                            _debugger.WindowRect = new Rect(_debugger.WindowRect.x, _debugger.WindowRect.y, width, _debugger.WindowRect.height);
                        }
                    }
                    GUILayout.EndHorizontal();
                    ...
                    GUILayout.BeginHorizontal();
                    {
                        ...
                        {
                            _debugger.WindowRect = new Rect(_debugger.WindowRect.x, _debugger.WindowRect.y, _debugger.WindowRect.width, height);
                        }
                    }
                    GUILayout.EndHorizontal();
