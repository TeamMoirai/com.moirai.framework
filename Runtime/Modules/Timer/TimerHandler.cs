...
namespace Moirai.Atropos.Timer
{
    ...
    /// 可在 <see cref="TimerSettings"/> 中替换为自定义实现。
    /// </summary>
    [Serializable]
    [UnityEngine.Scripting.Preserve]
    [Il2CppSetOption(Option.NullChecks, false)]
    [Il2CppSetOption(Option.ArrayBoundsChecks, false)]
    public class TimerHandler : FrameworkHandler
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public ulong AddTimer(TimerCallback callback, float time, bool isLoop = false, bool isUnscaled = false, params object[] args)
        {
            if (callback == null)
            {
                return 0UL;
        ...
        public int GetAllTimers(TimerDebugInfo[] results)
        {
