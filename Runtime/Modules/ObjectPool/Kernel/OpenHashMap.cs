...
namespace Moirai.Atropos.ObjectPool
{
    ...
    internal struct OpenHashMap<TKey> where TKey : IEquatable<TKey>
    {
        ...
        /// <summary>
        /// 初始化 <see cref="OpenHashMap{TKey}"/> 的新实例。
        /// </summary>
        ...
        public OpenHashMap(int capacity)
        {
            ...
            _keys = ArrayPool<TKey>.Shared.Rent(cap);
        ...
        private void Grow()
        {
            ...
            TKey[] newKeys = ArrayPool<TKey>.Shared.Rent(newCap);
