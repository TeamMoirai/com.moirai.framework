    ...
    public class SetUISafeFitHelper
    {
        ...
        public void SetUIFit()
        {
            ...
            if (LiuHaiFit)
            {
                ...
                {
                    offsetMax = new Vector3(_curFitRect.offsetMax.x, (cutouts[0].height));
                }
                ...
                // 刘海屏适配
                _curFitRect.offsetMax = new Vector2(offsetMax.x, -offsetMax.y);
            }
            else
            {
                // 非刘海屏适配
                _curFitRect.offsetMax = offsetMax;
            }
            ...
            if (BottomFit)
            {
                ...
                {
                    _curFitRect.offsetMin = new Vector2(_curFitRect.offsetMin.x, Mathf.Abs(offsetMin.y));
                }
                else
                {
                    _curFitRect.offsetMin = offsetMin;
                }
            }
            else
            {
        ...
        public void SetUINotFit(RectTransform rect)
        {
            ...
            float compensationY = -_curFitRect.offsetMax.y; // - _curFitRect.offsetMin.y;
