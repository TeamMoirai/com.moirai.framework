...
namespace Moirai.Atropos.UI
{
    ...
    /// <para>通过 <see cref="UISettings.UIHandler"/> 序列化配置，可替换为自定义 UI 后端。</para>
    /// </summary>
    public sealed partial class UIHandler : FrameworkHandler
    {
        ...
        /// 资源加载器。
        /// </summary>
        public IUIResourceLoader Resource { get; set; }
        ...
        public void ShowUIAsync<T>(string windowName = null, string assetName = null, bool fromResources = false, params object[] userData)
        ...
        /// <param name="fromResources">从 Resources 加载资源。</param>
        /// <param name="userData">用户自定义数据。</param>
        public void ShowUI<T>(string windowName = null, string assetName = null, bool fromResources = false, params object[] userData) where T : UIWindow, new()
        {
            ShowUIImp(typeof(T),
#if UNITY_WEBGL
                true
        ...
        /// <param name="fromResources">从 Resources 加载资源。</param>
        /// <param name="userData">用户自定义数据。</param>
        public void ShowUIAsync(Type type, string windowName = null, string assetName = null, bool fromResources = false, params object[] userData)
        {
        ...
        /// <param name="fromResources">从 Resources 加载资源。</param>
        /// <param name="userData">用户自定义数据。</param>
        public void ShowUI(Type type, string windowName = null, string assetName = null, bool fromResources = false, params object[] userData)
        {
            ShowUIImp(type,
#if UNITY_WEBGL
                true
        ...
        public async UniTask<UIWindow> ShowUIAsyncAwait<T>(string windowName = null, string assetName = null, bool fromResources = false, params object[] userData) where T : UIWindow, new()
        {
