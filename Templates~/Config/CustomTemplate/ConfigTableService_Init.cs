...
namespace GameProto.Config
{
	...
	/// </summary>
	public partial class ConfigTableService
	{
		private static ConfigTableService s_Instance;
		public static ConfigTableService Instance => s_Instance ??= new ConfigTableService();
